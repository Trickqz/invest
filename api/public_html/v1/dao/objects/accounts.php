<?php
require_once str_replace("/dao/objects", "", dirname(__FILE__)) . '/vendor/php-jwt/src/BeforeValidException.php';
require_once str_replace("/dao/objects", "", dirname(__FILE__)) . '/vendor/php-jwt/src/ExpiredException.php';
require_once str_replace("/dao/objects", "", dirname(__FILE__)) . '/vendor/php-jwt/src/SignatureInvalidException.php';
require_once str_replace("/dao/objects", "", dirname(__FILE__)) . '/vendor/php-jwt/src/JWT.php';
use \Firebase\JWT\JWT;

require_once str_replace("/dao/objects", "", dirname(__FILE__)) . '/vendor/lightncandy/src/Encoder.php';
require_once str_replace("/dao/objects", "", dirname(__FILE__)) . '/vendor/lightncandy/src/Flags.php';
require_once str_replace("/dao/objects", "", dirname(__FILE__)) . '/vendor/lightncandy/src/Context.php';
require_once str_replace("/dao/objects", "", dirname(__FILE__)) . '/vendor/lightncandy/src/Token.php';
require_once str_replace("/dao/objects", "", dirname(__FILE__)) . '/vendor/lightncandy/src/Parser.php';
require_once str_replace("/dao/objects", "", dirname(__FILE__)) . '/vendor/lightncandy/src/Validator.php';
require_once str_replace("/dao/objects", "", dirname(__FILE__)) . '/vendor/lightncandy/src/Partial.php';
require_once str_replace("/dao/objects", "", dirname(__FILE__)) . '/vendor/lightncandy/src/Expression.php';
require_once str_replace("/dao/objects", "", dirname(__FILE__)) . '/vendor/lightncandy/src/Exporter.php';
require_once str_replace("/dao/objects", "", dirname(__FILE__)) . '/vendor/lightncandy/src/Compiler.php';
require_once str_replace("/dao/objects", "", dirname(__FILE__)) . '/vendor/lightncandy/src/SafeString.php';
require_once str_replace("/dao/objects", "", dirname(__FILE__)) . '/vendor/lightncandy/src/LightnCandy.php';
require_once str_replace("/dao/objects", "", dirname(__FILE__)) . '/vendor/lightncandy/src/Runtime.php';

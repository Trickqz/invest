          ...
          switch (_context7.prev = _context7.next) {
            ...
            case 3:
              ...
              var regex = /[?&]([^=#]+)=([^&#]*)/g,
                ...
                var uurl = params.file;
                //uurl = uurl.substring(0, uurl.indexOf('?'));
                Object.keys(params).forEach(function(key) {
                    if (key != "file" && key != "api_key" && key != "authorization") {
                        if (!uurl.includes(key+"=")) {
                            if (uurl.includes("?")) {
                                uurl += "&"+key+"="+params[key];
                            } else {
                                uurl += "?"+key+"="+params[key];
...
var validateFileURL;
{
  var HOSTED_VIEWER_ORIGINS = ['null', 'http://mozilla.github.io', 'https://mozilla.github.io', 'https://app.commerce.brauntech.com.br', 'https://api.commerce.brauntech.com.br', 'https://app.seven7captal.developer.brauntech.com.br', 'https://app.seven7captal.com', 'https://api.seven7captal.developer.brauntech.com.br', 'https://api.seven7captal.com', 'https://admin.seven7captal.developer.brauntech.com.br', 'https://admin.seven7captal.com'];

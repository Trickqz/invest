//APP_ENV=local
const CFG__APP_KEY              = 'base64:5F/Ax5Z5EKykQdkICT5C1NdyIXZsZY7ZXRundsBBmEQ=';
...
const CFG__APP_PWA_MODE         = true;
const CFG__ENABLE_ANIMATION     = true;

//const APP_DEFAULT_TIMEZONE            = America/Sao_Paulo
const CFG__APP_DEFAULT_THEME_COLOR      = '#f35731'
//const APP_MAINTENANCE_MODE            = false
//const APP_MAINTENANCE_MODE_MSG        = Estamos em manutenção / atualização.<br />Previsão de retorno dia 11/08 às 09:30h.

const CFG__API_KEY              = '609e5ecb-724d-e523-8cff-df90';
...
const CFG__API_GRAPHQL_URL      = '';  //'https://api.commerce.brauntech.com.br/services/graphql';

                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-9">
                                    ...
                                    <p>
                                        <span style="width: 70px;display: inline-block;"><b>Name:</b></span> {{system.userdata._name}}<br />
                                        <span style="width: 70px;display: inline-block;"><b>Username:</b></span> {{system.userdata._username}}<br />
                                        {{#contains "natural_person" system.userdata._type}}
                                            <span style="width: 70px;display: inline-block;"><b>CPF:</b></span> {{system.userdata._cpf}}<br /><br />
                                        {{else}}
                                        {{/contains}}
                                        {{#contains "legal_person" system.userdata._type}}
                                            <span style="width: 70px;display: inline-block;"><b>CNPJ:</b></span> {{system.userdata._cnpj}}<br /><br />
                                        {{else}}
                                        {{/contains}}
                                        <span style="width: 70px;display: inline-block;"><b>Mobile phone:</b></span> {{system.userdata._mobile_phone}}<br />
                                        <span style="width: 70px;display: inline-block;"><b>Email:</b></span> {{system.userdata._email}}<br />
                                        <span style="width: 70px;display: inline-block;"><b>Coinbase Account (email):</b></span> {{system.userdata._coinbase_email}}<br />
                                        
                                        {{#if system.isadmin}}
                                        {{else}}
                                            <span style="width: 70px;display: inline-block;"><b>Sponsor:</b></span> {{system.userdata.network.sponsor}}<br />
                                        {{/if}}
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p>
                                <span style="width: 70px;display: inline-block;"><b>Wallet:</b></span> {{system.userdata._crypto_wallet}}<br />
                            </p>

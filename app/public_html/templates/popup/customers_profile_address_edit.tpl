<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title">Edit address of <b>{{tmp._name}}</b></h5>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="mb-3">
                        ...
                        <input name="postal_code" type="text" class="form-control" placeholder="Postal Code" value="{{tmp._address_postal_code}}" style="max-width: 180px;" data-inputmask="'mask': '99.999-999'" onblur="loadPostalCode();" inputmode="numeric" autocomplete="off" />
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="mb-3">
                            ...
                            <input name="city" type="text" class="form-control" placeholder="City" value="{{tmp._address_city}}" />
                        </div>
                        <!--<div class="mb-3">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="mb-3">
                            ...
                            <input name="street" type="text" class="form-control" placeholder="Address" value="{{tmp._address_street}}" />
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="mb-3">
                            <label class="form-label">Number</label>
                            <input name="number" type="text" class="form-control" placeholder="Number" value="{{tmp._address_number}}" />
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-8">
                        <div class="mb-3">
                            ...
                            <input name="district" type="text" class="form-control" placeholder="District" value="{{tmp._address_district}}" />
                        </div>
                    </div>
                    <div class="col-lg-8">
                        <div class="mb-3">
                            <label class="form-label">Complement</label>
                            <input name="complement" type="text" class="form-control" placeholder="Complement" value="{{tmp._address_complement}}" />
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    function formAccountProfileAddressEdit__Save() {
        ...
        var jsonData = JSON.parse(formToJSONString('formAccountProfileAddressEdit'));
        
        $.ajax({
            type: "POST",
            url: CFG__API_URL + CFG__API_VERSION + "/accounts/{{tmp._id}}/address",
            data: jsonData,
    ...
    function loadPostalCode() {
        ...
        if (cep != "") {
            ...
            if (validacep.test(cep)) {
                ...
                document.getElementById("postal_code--invalid-feedback").innerHTML = "Postal Code invalid";
            }
        } else {
            document.querySelector('#formAccountProfileAddressEdit input[name="postal_code"]').classList.add("is-invalid");
            document.getElementById("postal_code--invalid-feedback").innerHTML = "Postal Code invalid";

                ...
                if (arr.length > 0) {
                    for (var i = 0; i < arr.length; i++){
                        ...
                        tbodyHTML += 
                            ...
                            + '    <td>'
                            + '        <div class="btn-list flex-nowrap">'
                            + '             <button type="button" class="btn btn-primary" onclick="View.openFormCustomer(\'' + arr[i]._id + '\');">'
                            + '                 <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-search" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">'
                            + '                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>'
                            + '                    <circle cx="10" cy="10" r="7"></circle>'
                            + '                    <line x1="21" y1="21" x2="15" y2="15"></line>'
                    ...
                    if (response.count > 0) {
                        ...
                        onclickPrev = 'fc__customersGetAll(\'*\', \'\', '+(Math.floor(my_store__customersAfter/search_q.limit)-1)+');';
                        onclickNext = 'fc__customersGetAll(\'*\', \'\', '+(Math.floor(my_store__customersAfter/search_q.limit)+2)+');';
                    }
